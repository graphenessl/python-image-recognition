...
# Next up, we're going to start using our example numbers data.
# We want to create image arrays out of our numbers data, saving them,
# so that we can reference them later for pattern recognition.
def createExamples():
